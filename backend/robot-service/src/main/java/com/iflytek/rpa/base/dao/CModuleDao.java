...
public interface CModuleDao extends BaseMapper<CModule> {
    ...
    List<CModule> getAllModuleList(@Param("robotId") String robotId, @Param("robotVersion") Integer robotVersion, @Param("userId") String userId);
    ...
    @Select("select * " +
            ...
            "and creator_id = #{userId} and robot_id = #{robotId} and robot_version = #{robotVersion} " +
            "order by id asc")
    List<CModule> getAllModuleListOrderByIdAsc(@Param("robotId") String robotId, @Param("robotVersion") Integer robotVersion, @Param("userId") String userId);
    ...
    @Select("select * " +
            ...
            "order by id asc")
    List<CModule> getAllModuleListWithoutUserId(@Param("robotId") String robotId, @Param("robotVersion") Integer robotVersion);


    @Select("select * from c_process where deleted = 0 and robot_id = #{robotId} and robot_version = #{robotVersion} order by create_time desc")
    List<CProcess> getAllProcessListWithOutUserId(@Param("robotId") String robotId, @Param("robotVersion") Integer robotVersion);
    ...
    @Select("select module_name " +
            ...
            "order by create_time desc")
    List<String> getAllModuleNameExpSelf(@Param("robotId") String robotId, @Param("robotVersion") Integer robotVersion, @Param("userId") String userId, @Param("moduleId") String moduleId);
    ...
    @Select("select module_name " +
            ...
            "and creator_id = #{userId} and robot_id = #{robotId} and robot_version = #{robotVersion} " +
            "order by create_time desc")
    List<String> getAllModuleName(@Param("robotId") String robotId, @Param("robotVersion") Integer robotVersion, @Param("userId") String userId);
    ...
    Integer createModuleForObtainedVersion(@Param("obtainedRobotDesign") RobotDesign obtainedRobotDesign, @Param("authorRobotVersion")RobotVersion authorRobotVersion);
    ...
    Long getIdByModuleId(@Param("moduleId") String moduleId, @Param("userId") String userId, @Param("robotId") String robotId);

    boolean updateModuleContentById(@Param("id") Long id, @Param("moduleContent") String moduleContent, @Param("breakpoint") String breakpoint);
