...
public interface CGroupDao extends BaseMapper<CGroup> {
    ...
    List<CGroup> getGroupByRobotId(@Param("robotId") String robotId, @Param("robotVersion") Integer robotVersion, @Param("elementType") String elementType);

    Integer createGroupForCurrentVersion(RobotVersionDto robotVersionDto);

    Integer createGroupForObtainedVersion(@Param("obtainedRobotDesign") RobotDesign obtainedRobotDesign, @Param("authorRobotVersion") RobotVersion authorRobotVersion);
