...
public class AppMarketUserServiceImpl extends ServiceImpl<AppMarketUserDao, AppMarketUser> implements AppMarketUserService {
    ...
    public AppResponse<?> getUserUnDeployed(MarketDto marketDto) throws NoLoginException {
        ...
        AppResponse<List<com.iflytek.rpa.common.feign.entity.MarketDto>> response = rpaAuthFeign.getUserUnDeployed(queryDto);
    ...
    public AppResponse getUserList(MarketDto marketDto) throws NoLoginException {
        ...
        if(!appMarket.getMarketType().equals("public")){
            ...
            AppResponse<PageDto<com.iflytek.rpa.common.feign.entity.MarketDto>> feignResponse = rpaAuthFeign.getMarketUserList(queryDto);
            ...
            AppResponse<PageDto<com.iflytek.rpa.common.feign.entity.MarketDto>> feignResponse = rpaAuthFeign.getMarketUserListByPublic(queryDto);
            if (feignResponse == null || !feignResponse.ok()) {
                userListPage = new Page<>(marketDto.getPageNo(), marketDto.getPageSize(), true);
            } else {
                PageDto<com.iflytek.rpa.common.feign.entity.MarketDto> pageDto = feignResponse.getData();
    ...
    public AppResponse getUserByPhone(GetMarketUserByPhoneDto marketDto) {
        ...
        AppResponse<List<com.iflytek.rpa.common.feign.entity.MarketDto>> feignResponse = rpaAuthFeign.getMarketUserByPhone(marketDto);
    ...
    public AppResponse getUserByPhoneForOwner(MarketDto marketDto) throws NoLoginException {
        ...
        AppResponse<List<com.iflytek.rpa.common.feign.entity.MarketDto>> feignResponse = rpaAuthFeign.getMarketUserByPhoneForOwner(queryDto);
    ...
    public AppResponse inviteUser(MarketDto marketDto) throws NoLoginException {
        ...
        AppResponse<List<com.iflytek.rpa.common.feign.entity.TenantUser>> feignResponse = rpaAuthFeign.getMarketTenantUserList(queryDto);
