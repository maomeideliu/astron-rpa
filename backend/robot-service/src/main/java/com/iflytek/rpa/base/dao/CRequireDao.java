...
public interface CRequireDao extends BaseMapper<CRequire> {
    ...
    Integer createRequireForObtainedVersion(@Param("obtainedRobotDesign") RobotDesign obtainedRobotDesign,
    ...
    List<CRequire> getRequire(@Param("robotId") String robotId, @Param("version") Integer version, @Param("userId") String userId);
