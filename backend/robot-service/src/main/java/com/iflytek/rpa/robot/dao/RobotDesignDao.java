...
public interface RobotDesignDao extends BaseMapper<RobotDesign> {
    ...
    List<String> getRobotNameList(@Param("tenantId") String tenantId,
                                  @Param("userId") String userId,
                                  @Param("robotNameBase") String robotNameBase);

    RobotDesign getRobotDesignInfo(@Param("robotId") String robotId,
                                   @Param("userId") String userId,
    ...
    Integer updateTransformStatus(@Param("userId") String userId,
    ...
    Integer deleteDesign(@Param("robotId") String robotId, @Param("userId") String userId, @Param("tenantId") String tenantId);

    @Select("select id " +
            "from robot_design " +
            "where robot_id = #{robotId} and creator_id = #{userId} and tenant_id = #{tenantId} and deleted = 0")
    Integer getDesignId(@Param("robotId") String robotId, @Param("userId") String userId, @Param("tenantId") String tenantId);

    @Update("update robot_design " +
            "set deleted = 1, update_time = now() " +
            "where id = #{id}")
    Integer deleteDesignById(@Param("id") Integer id);

    List<RobotDesign> getDesignByAppIdList(@Param("userId") String userId, @Param("tenantId") String tenantId,
    ...
    @Select("select * " +
            ...
            "limit 1")
    RobotDesign getDesignByAppId(@Param("userId") String userId, @Param("tenantId") String tenantId,
    ...
    @Update("update robot_design " +
            "set name = #{newName} ,transform_status = 'editing' " +
            "where deleted = 0 and robot_id = #{robotId} and creator_id = #{userId} and tenant_id = #{tenantId}")
    boolean updateRobotName(@Param("newName") String newName,
                            @Param("robotId") String robotId,
                            @Param("userId") String userId,
                            @Param("tenantId") String tenantId);
    ...
    @Update("update robot_design " +
            "set name = #{newName} " +
            "where deleted = 0 and robot_id = #{robotId} and creator_id = #{userId} and tenant_id = #{tenantId}")
    boolean updateRobotNameWithoutSetEditing(@Param("newName") String newName,
                            @Param("robotId") String robotId,
                            @Param("userId") String userId,
                            @Param("tenantId") String tenantId);
    ...
    @Select("select name " +
            "from robot_design " +
            "where deleted = 0 and robot_id = #{robotId} and creator_id = #{userId} and tenant_id = #{tenantId}")
    String getRobotName(@Param("robotId") String robotId,
                    @Param("userId") String userId,
                    @Param("tenantId") String tenantId);

    @Select("select market_id " +
            "from robot " +
            "where deleted = 0 and robot_id = #{robotId} and creator_id = #{userId} and tenant_id = #{tenantId}")
    String getMarketId(@Param("robotId") String robotId,
                        @Param("userId") String userId,
                        @Param("tenantId") String tenantId);
    ...
    Integer checkNameDup(@Param("userId") String userId, @Param("tenantId") String tenantId, @Param("newName") String newName, @Param("robotId") String robotId);


    @Select("select count(name) " +
            "from robot_design " +
            "where deleted = 0 and creator_id = #{userId} and tenant_id = #{tenantId} and name = #{newName}")
    Integer checkNameDupWithoutRobotId(@Param("userId") String userId, @Param("tenantId") String tenantId, @Param("newName") String newName);

    @Select("select * " +
            "from robot_design " +
            "where deleted = 0 and creator_id = #{userId} and tenant_id = #{tenantId} and robot_id = #{robotId}")
    RobotDesign getRobot(@Param("robotId") String robotId, @Param("userId") String userId, @Param("tenantId") String tenantId);

    @Select("select * " +
            "from robot_design " +
            "where creator_id = #{userId} and tenant_id = #{tenantId} and robot_id = #{robotId}")
    RobotDesign getRobotRegardlessLogicDel(@Param("robotId") String robotId, @Param("userId") String userId, @Param("tenantId") String tenantId);
