...
public interface CasdoorUserDao {
     ...
     * @return 用户列表
     */
    List<User> searchUserByPhone(@Param("keyword") String keyword, 
                                  @Param("owner") String owner,
                                  @Param("databaseName") String databaseName);
     ...
     * @return 用户列表
     */
    List<User> searchUserByNameOrPhone(@Param("keyword") String keyword, 
                                        @Param("owner") String owner,
                                        @Param("databaseName") String databaseName);
    ...
    IPage<MarketDto> getMarketUserList(
            IPage<MarketDto> page,
            @Param("dto") GetMarketUserListDto dto,
            @Param("databaseName") String databaseName);
}
