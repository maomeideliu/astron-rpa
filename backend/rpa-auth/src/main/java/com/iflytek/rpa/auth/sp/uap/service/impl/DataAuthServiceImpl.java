...
public class DataAuthServiceImpl implements DataAuthService {
    ...
    @Override
    public AppResponse<List<com.iflytek.rpa.auth.core.entity.DataAuthorityWithDimDictDto>> getCheckedDataAuth(String roleId, HttpServletRequest request) {
...
//        List<DataAuthorityWithDimDictDto> dataAuthList =  UapUserInfoAPI.getDataAuthList(request);
        ...
        //获取勾选的数据权限
        List<DataAuthorityWithDimDictDto> checkedDataAuthList = UapManagementClientUtil.queryDataAuthByRoleId(tenantId, roleId, request);
        ...
        List<com.iflytek.rpa.auth.core.entity.DataAuthorityWithDimDictDto> dataAuthorityWithDimDictDtos = dataAuthorityWithDimDictDtoMapper.fromUapDataAuthorityWithDimDictDtos(dataAuthList);
    ...
    public AppResponse<String> bindDataAuth(BindRoleDataAuthDto bindRoleDataAuthDto, HttpServletRequest request) {
        if (StringUtils.isBlank(bindRoleDataAuthDto.getRoleId()) || StringUtils.isBlank(bindRoleDataAuthDto.getDataAuthId())) {
        ...
        //查询角色之前绑定的数据权限
        String tenantId = UapUserInfoAPI.getTenantId(request);
        List<DataAuthorityWithDimDictDto> oldBindDataAuthList = UapManagementClientUtil.queryDataAuthByRoleId(tenantId, roleId, request);
