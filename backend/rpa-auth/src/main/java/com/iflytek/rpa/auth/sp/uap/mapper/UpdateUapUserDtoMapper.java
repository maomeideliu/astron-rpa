...
public class UpdateUapUserDtoMapper {
     ...
     */
    public com.iflytek.sec.uap.client.core.dto.user.UpdateUapUserDto toUapUpdateUapUserDto(UpdateUapUserDto updateUapUserDto) {
        ...
        // 转换extands属性
        if (updateUapUserDto.getExtands() != null && !updateUapUserDto.getExtands().isEmpty()) {
     ...
     */
    public UpdateUapUserDto fromUapUpdateUapUserDto(com.iflytek.sec.uap.client.core.dto.user.UpdateUapUserDto uapUpdateUapUserDto) {
        ...
        // 转换extands属性
        if (uapUpdateUapUserDto.getExtands() != null && !uapUpdateUapUserDto.getExtands().isEmpty()) {
     ...
     */
    private UpdateUserDto fromUapUpdateUserDto(com.iflytek.sec.uap.client.core.dto.user.UpdateUserDto uapUpdateUserDto) {
