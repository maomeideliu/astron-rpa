...
public class UapExtendPropertyDtoMapper {
     ...
     */
    public com.iflytek.sec.uap.client.core.dto.extand.UapExtendPropertyDto toUapExtendPropertyDto(UapExtendPropertyDto uapExtendPropertyDto) {
     ...
     */
    public UapExtendPropertyDto fromUapExtendPropertyDto(com.iflytek.sec.uap.client.core.dto.extand.UapExtendPropertyDto uapExtendPropertyDto) {
        if (uapExtendPropertyDto == null) {
            return null;
        }
     ...
     */
    public List<com.iflytek.sec.uap.client.core.dto.extand.UapExtendPropertyDto> toUapExtendPropertyDtoList(List<UapExtendPropertyDto> uapExtendPropertyDtoList) {
     ...
     */
    public List<UapExtendPropertyDto> fromUapExtendPropertyDtoList(List<com.iflytek.sec.uap.client.core.dto.extand.UapExtendPropertyDto> uapExtendPropertyDtoList) {
        if (uapExtendPropertyDtoList == null || uapExtendPropertyDtoList.isEmpty()) {
            return Collections.emptyList();
        }
