...
public class UserUtils {
    ...
    public static UapUser getUserInfoByPhone(String phone){
        ...
        PageDto<UapUser> userList = ClientManagementAPI.queryUserPageList(UapUserInfoAPI.getTenantId(HttpUtils.getRequest()), listUserDto);
    ...
    public static List<UapUser> searchUserByName(String keyword, String deptId) {
        ...
        PageDto<UapUser> userListByName = ClientManagementAPI.queryUserPageList(UapUserInfoAPI.getTenantId(HttpUtils.getRequest()), listUserDto);
    ...
    public static List<UapUser> searchUserByPhone(String keyword, String deptId) {
        ...
        PageDto<UapUser> userListByPhone = ClientManagementAPI.queryUserPageList(UapUserInfoAPI.getTenantId(HttpUtils.getRequest()), listUserDtoByPhone);
