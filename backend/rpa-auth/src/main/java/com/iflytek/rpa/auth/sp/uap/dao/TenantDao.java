...
public interface TenantDao {
    ...
    List<UserVo> getUserByTenantId(@Param("databaseName") String databaseName, 
     ...
     * @return 租户列表
     */
    List<UapTenant> queryTenantListByPhone(@Param("databaseName") String databaseName,
                                            @Param("phone") String phone);
    String getTenantUserId(@Param("databaseName") String databaseName,@Param("userId") String userId, @Param("tenantId") String tenantId);

    Integer getTenantUserStatus(@Param("databaseName") String databaseName,@Param("userId") String userId, @Param("tenantId") String tenantId);

    Integer enableTenantUser(@Param("databaseName") String databaseName, @Param("id")String id,@Param("status") Integer status);

    Integer updateLoginTime(String databaseName, String id);

    List<String> getTenantUserIdsByType(@Param("databaseName") String databaseName, @Param("tenantId") String tenantId, @Param("tenantUserType") Integer tenantUserType);

    List<String> getNoClassifyTenantIds(@Param("databaseName") String databaseName);

    Integer updateTenantClassifyCompleted(@Param("databaseName") String databaseName,@Param("tenantIds") List<String> tenantIds);
     ...
     */
    Integer getTenantUserType(@Param("databaseName") String databaseName, @Param("userId") String userId, @Param("tenantId") String tenantId);
     ...
     * @return 受影响行数
     */
    Integer deleteTenantUser(@Param("databaseName") String databaseName,
                             @Param("tenantId") String tenantId,
     ...
     * @return 受影响行数
     */
    Integer updateTableTenantId(@Param("databaseName") String databaseName,
    ...
    List<com.iflytek.rpa.auth.core.entity.TenantUser> queryTenantUsersForSync(
            ...
            @Param("excludeTenantIds") List<String> excludeTenantIds);
