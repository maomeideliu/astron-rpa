...
class TestDataConvertProcess(unittest.TestCase):
    ...
    def test_json_convertor_json_to_str(self):
        ...
        result = DataConvertProcess.json_convertor(
            input_data=self.test_dict, convert_type=JSONConvertType.JSON_TO_STR
        )
    ...
    def test_json_convertor_with_list(self):
        """测试列表转JSON字符串"""
        result = DataConvertProcess.json_convertor(
            input_data=self.test_list, convert_type=JSONConvertType.JSON_TO_STR
        )
        expected = '[1, 2, 3, "测试"]'
        self.assertEqual(result, expected)
    ...
    def test_str_to_other_str_to_int(self):
        ...
        result = DataConvertProcess.str_to_other(
            input_data="123", convert_type=StringConvertType.STR_TO_INT
        )
        self.assertEqual(result, 123)
    ...
    def test_str_to_other_str_to_int_with_float_string(self):
        """测试带小数点的字符串转整数（取整数部分）"""
        result = DataConvertProcess.str_to_other(
            input_data="123.45", convert_type=StringConvertType.STR_TO_INT
        )
        self.assertEqual(result, 123)
    ...
    def test_str_to_other_str_to_float(self):
        """测试字符串转浮点数"""
        result = DataConvertProcess.str_to_other(
            input_data="123.45", convert_type=StringConvertType.STR_TO_FLOAT
        )
        self.assertEqual(result, 123.45)
    ...
    def test_str_to_other_str_to_bool_true_1(self):
        """测试字符串'1'转布尔值"""
        result = DataConvertProcess.str_to_other(
            input_data="1", convert_type=StringConvertType.STR_TO_BOOL
        )
        self.assertEqual(result, True)
    ...
    def test_str_to_other_str_to_bool_true_string(self):
        """测试字符串'True'转布尔值"""
        result = DataConvertProcess.str_to_other(
            input_data="True", convert_type=StringConvertType.STR_TO_BOOL
        )
        self.assertEqual(result, True)
    ...
    def test_str_to_other_str_to_bool_false_0(self):
        """测试字符串'0'转布尔值"""
        result = DataConvertProcess.str_to_other(
            input_data="0", convert_type=StringConvertType.STR_TO_BOOL
        )
    ...
    def test_str_to_other_str_to_bool_false_string(self):
        """测试字符串'False'转布尔值"""
        result = DataConvertProcess.str_to_other(
            input_data="False", convert_type=StringConvertType.STR_TO_BOOL
        )
        self.assertEqual(result, False)
    ...
    def test_str_to_other_str_to_bool_other_string(self):
        """测试其他字符串转布尔值"""
        result = DataConvertProcess.str_to_other(
            input_data="hello", convert_type=StringConvertType.STR_TO_BOOL
        )
    ...
    def test_str_to_other_invalid_int(self):
        ...
        with self.assertRaises(Exception):
            DataConvertProcess.str_to_other(
                input_data="abc", convert_type=StringConvertType.STR_TO_INT
            )
    ...
    def test_str_to_other_invalid_float(self):
        ...
        with self.assertRaises(Exception):
            DataConvertProcess.str_to_other(
                input_data="abc", convert_type=StringConvertType.STR_TO_FLOAT
            )
    ...
    def test_str_to_other_invalid_list(self):
        ...
        with self.assertRaises(Exception):
            DataConvertProcess.str_to_other(
                input_data="invalid_list", convert_type=StringConvertType.STR_TO_LIST
            )
    ...
    def test_str_to_other_invalid_dict(self):
        ...
        with self.assertRaises(Exception):
            DataConvertProcess.str_to_other(
                input_data="invalid_dict", convert_type=StringConvertType.STR_TO_DICT
            )
    ...
    def test_str_to_other_invalid_tuple(self):
        ...
        with self.assertRaises(Exception):
            DataConvertProcess.str_to_other(
                input_data="invalid_tuple", convert_type=StringConvertType.STR_TO_TUPLE
            )
    ...
    def test_edge_cases_empty_string_to_int(self):
        ...
        with self.assertRaises(Exception):
            DataConvertProcess.str_to_other(
                input_data="", convert_type=StringConvertType.STR_TO_INT
            )
    ...
    def test_edge_cases_empty_string_to_float(self):
        ...
        with self.assertRaises(Exception):
            DataConvertProcess.str_to_other(
                input_data="", convert_type=StringConvertType.STR_TO_FLOAT
            )

    def test_edge_cases_empty_string_to_bool(self):
        """测试边界情况：空字符串转布尔值"""
        result = DataConvertProcess.str_to_other(
            input_data="", convert_type=StringConvertType.STR_TO_BOOL
        )
        self.assertEqual(result, False)
    ...
    def test_edge_cases_complex_json(self):
        ...
        # JSON转字符串
        json_str = DataConvertProcess.json_convertor(
            input_data=complex_data, convert_type=JSONConvertType.JSON_TO_STR
        )

        # 字符串转JSON
        result = DataConvertProcess.json_convertor(
            input_data=json_str, convert_type=JSONConvertType.STR_TO_JSON
        )
    ...
    def test_edge_cases_nested_structures(self):
        ...
        result = DataConvertProcess.str_to_other(
            input_data=nested_str, convert_type=StringConvertType.STR_TO_DICT
        )
