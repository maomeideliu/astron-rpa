...
from rpadataprocess import DeleteMethodType, InsertMethodType, ListType, SortMethodType
...
class TestListProcess(unittest.TestCase):
    ...
    def test_create_new_list_same_data(self):
        """测试创建相同数据的列表"""
        result = ListProcess.create_new_list(
            list_type=ListType.SAME_DATA, size=5, value="test"
        )
    ...
    def test_create_new_list_user_defined(self):
        ...
        result = ListProcess.create_new_list(
            list_type=ListType.USER_DEFINED, value=custom_list
        )
    ...
    def test_create_new_list_with_string_format(self):
        """测试使用字符串格式创建列表"""
        result = ListProcess.create_new_list(
            list_type=ListType.USER_DEFINED, value="[1, 2, 3, 4, 5]"
        )
    ...
    def test_insert_value_to_list_append(self):
        ...
        result = ListProcess.insert_value_to_list(
            list_data=test_list, value=4, insert_method=InsertMethodType.APPEND
        )
    ...
    def test_change_value_in_list(self):
        """测试修改列表中的元素"""
        test_list = [1, 2, 3, 4, 5]
        result = ListProcess.change_value_in_list(
            list_data=test_list, index="2", new_value=10
        )
    ...
    def test_remove_value_from_list_by_index(self):
        ...
        result = ListProcess.remove_value_from_list(
            list_data=test_list, del_mode=DeleteMethodType.INDEX, del_pos="2"
        )
    ...
    def test_remove_value_from_list_by_value_not_found(self):
        ...
        test_list = ["apple", "banana", "cherry"]
        with self.assertRaises(ValueError):
            ListProcess.remove_value_from_list(
                list_data=test_list, del_mode=DeleteMethodType.VALUE, del_value="orange"
            )

    def test_sort_list_asc(self):
        """测试列表升序排序"""
        test_list = [3, 1, 4, 1, 5, 9, 2, 6]
        result = ListProcess.sort_list(
            list_data=test_list, sort_method=SortMethodType.ASC
        )
    ...
    def test_sort_list_desc(self):
        ...
        test_list = [3, 1, 4, 1, 5, 9, 2, 6]
        result = ListProcess.sort_list(
            list_data=test_list, sort_method=SortMethodType.DESC
        )
    ...
    def test_filter_elements_from_list(self):
        ...
        list1 = [1, 2, 3, 4, 5]
        list2 = [2, 4]
        result = ListProcess.filter_elements_from_list(
            list_data_1=list1, list_data_2=list2
        )
    ...
    def test_get_common_elements_from_list(self):
        ...
        list1 = [1, 2, 3, 4, 5]
        list2 = [3, 4, 5, 6, 7]
        result = ListProcess.get_common_elements_from_list(
            list_data_1=list1, list_data_2=list2
        )
    ...
    def test_list_legal_check_empty_list_error(self):
        ...
        test_list = []
        with self.assertRaises(ValueError):
            ListProcess.change_value_in_list(
                list_data=test_list, index="0", new_value=10
            )
    ...
    def test_list_legal_check_index_out_of_range(self):
        ...
        with self.assertRaises(ValueError):
            ListProcess.change_value_in_list(
                list_data=test_list, index="10", new_value=10
            )
    ...
    def test_list_legal_check_invalid_index_format(self):
        ...
        with self.assertRaises(ValueError):
            ListProcess.change_value_in_list(
                list_data=test_list, index="abc", new_value=10
            )
