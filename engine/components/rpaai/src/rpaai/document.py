...
class DocumentAI:
    ...
    @staticmethod
    @atomicMg.atomic(
        "DocumentAI", outputList=[atomicMg.param("theme_expand_res", types="Str")]
    )
    ...
    @staticmethod
    @atomicMg.atomic(
        "DocumentAI", outputList=[atomicMg.param("sentence_expand_res", types="Str")]
    )
    ...
    @staticmethod
    @atomicMg.atomic(
        "DocumentAI", outputList=[atomicMg.param("sentence_reduce_res", types="Str")]
    )
